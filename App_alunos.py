from Usuarios_aluno import Usuarios
from tkinter import *
...
class Application:
    def __init__(self, master=None):
        ...
        self.lblnome = Label(self.container3, text="Nome do Aluno:", font=self.fonte, width=15)
        ...
        self.lbltelefone = Label(self.container4, text="Cpf do Aluno:", font=self.fonte, width=11)
